...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { data_file: @datum.data_file, data_name: @datum.data_name, sequencing_id: @datum.sequencing_id }
    end
  ...
  test "should update datum" do
    put :update, id: @datum, datum: { data_file: @datum.data_file, data_name: @datum.data_name, sequencing_id: @datum.sequencing_id }
    assert_redirected_to datum_path(assigns(:datum))
  end
